    ...
    const slug=["canvas-on-faces","bgmi-badshah","digital-india","engineers-got-talent","htmlcombat","pirates","picasso","engineerstride","mr-ms-uu","head-scratch","life-of-an-engineer","innovate-india","character-clash","crackncode","anyday-anime","cook-without-fire"]
    useEffect(() => {
        ...
        setindex(i.current)
       studentCod[i.current].map((item, j) =>{console.log(i.current[0])})
    },[])
    
        const descriptions = [`Unleash your creativity and transform faces into masterpieces! 'Canvas on Face' is a vibrant face art competition where talented artists showcase their skills and imagination. Using Faces as their canvas, participants will create stunning designs, patterns, and characters Witness the artistry and skill as our contestants bring their visions to life. Join us for a colorful and inspiring event that will leave you amazed by the possibilities of face art.
    ...
    ,`Step into a time capsule at our Fashion Show, where the vibrant styles of the 90's meet contemporary Indo-Western flair. This event is a celebration of nostalgia and innovation, blending classic 90's trends with modern design elements. Expect a runway filled with bold prints, vintage silhouettes, and fusion ensembles that capture the essence of two iconic fashion worlds. Join us for an evening of style, creativity, and timeless elegance`,
    ...
    `
        ...
        const eventguid = [[
            ...
            [
                ["Team Composition", "The team should consist of 4 registered players from each department only. No extra members or substitutes will be allowed"],
                ["Disqualification", "The team will be disqualified if caught cheating, exploiting bugs, engaging in ringing, or displaying toxic behavior towards other players"],
                ["Arrival Time", "Teams should be present 1 hour before the commencement of the tournament for head count and placement"],
                ["Registration Requirements", "The minimum requirement for the ID for registration is a level 35 account, and the rank should be more than Platinum V"],
                ["Device Check", "Phones will be thoroughly checked for hacks and mod files upon entering the tournament premises"],
                ["Team Representation", "The In-Game Leader (IGL) from each team will represent their team and will be responsible for point tally, reporting discrepancies, or suspecting other players of hacking"],
                
            ],
            [
                ["Robot Type", "Participants must build and program a robot capable of navigating a pre-set course and suitable for off-roading"],
                ["Time Limit", "Participants will have approximately 3 minutes to complete the race"],
                ["Operation", "Robots must operate autonomously or through remote control"],
                ["Dimensions", "Robots must not exceed the dimensions of 25cm × 20cm × 15cm (L × B × H)"],
                ["Disqualification", "Any external assistance during the race will result in disqualification"],
                ["Track Penalty", "Robots are required to stay on the track during the race; failure to do so will result in a penalty"],
                ["Safety", "Robots must not cause damage to the track or other robots"],
                
            ],
            [
                ["Performance Limit", "Each performance should be no longer than 3 minutes"],
                ["Content", "All acts must be appropriate for a general audience and safe to perform on stage"],
                ["Categories", "Talent can include singing, dancing, stand-up comedy, instrumental performance, etc."],
                ["Non-Competitive", "This is a showcase event; no prizes will be awarded but certificates will be provided"],
                ["Setup", "Participants must arrange for any special equipment or props needed for their act"]
                
            ],
            [
                ["Originality", "No plagiarism is allowed; the code must be original and created on the spot"],
                ["Hosting", "The project must be hosted on GitHub"],
                ["Collaboration", " No external help other than from the team member(s), if any, is allowed"],
                ["Disqualification", "Any kind of nuisance created during the event will lead to immediate disqualification"],
                ["Resources", "Participants will be provided with a computer system to implement their work"]
                
            ],
            [
                ["Boat Type", "Participants must build a small boat that can float and navigate through a water course"],
                ["Materials", "Teams must construct their boats using their own materials"],
                ["Rules", "Boats can be either powered by manual (e.g., wind, hand propulsion) or motorized means"],
                ["Disqualification", "The size of the boat must not exceed by 1 foot otherwise will lead to disqualification"],
            ...
            [
                ...
                ["Presentation", "The artwork should be presented with a brief explanation (2-3 minutes)"],
            ...
            [
                ...
                ["Format", "Complete tasks to qualify for the next level; no skipping allowed"],
                ["Scoring", "Points based on task completion and time"],
                ["Conduct", "Follow safety rules; no cheating"],
                ["Prize", "The participant to finish all the tasks while following safety rules wins"],
                
            ],
            [
                ["Theme", "The event will focus on representing the '90s Indo-Western dress code, blending traditional and modern elements"],
                ["Team Structure", "Near Lamour Bakehouse"],
                ["Event Day", "Each department can field only one team, which must consist of 6 members—3 boys and 3 girls"],
                ["Attire", "Participants must bring their own costumes and accessories, ensuring they align with the theme and are appropriate for a general audience. All attire should be tasteful and respectful, avoiding any offensive or inappropriate content. Costumes and props should not obstruct movement or pose a tripping hazard, and no hazardous materials are allowed on stage"],
                ["Time Limit", "Each team will have a maximum of 10 minutes to present their walk and poses"],
                ["Safety", "Participants must ensure that their costumes and props do not pose a safety risk or cause any obstruction"],
            ],
            [
                ["Format", "Multiple rounds (MCQs, rapid-fire, final round)"],
                ["Topics", " Engineering, technology, general knowledge of tech"],
                ["Time Duration", "1 hour"],
                ["Rules", "No electronic devices allowed; decisions by quiz masters are final"],
                ["Tie-Breaker", "In case of a tie, an additional round of questions will determine the winner"],
            ],
            [
                ["Theme", "Life of an Engineer"],
                ["Duration", "Each video must be 1-2 minutes long"],
                ["Content", "The content must be original and relevant to the theme provided"],
                ["Submission Deadline", "Videos must be submitted by 10th September, 2024"],
                ["Disqualification", "Plagiarized content or the use of AI will lead to immediate disqualification"],
                ["Team Size", "Maximum of 2 people per team"]
            ],
            [
                ["Working Model Requirement", "The model presented must be fully functional and demonstrate the intended engineering principles or concepts. Non-functional or incomplete models will not be accepted for the presentation."],
                ["Material Restrictions", "The use of thermocol (polystyrene foam) is strictly prohibited in the construction of the models. Participants are encouraged to use sustainable, durable, and safe materials that effectively showcase their design."],
                ["Model Report", "A detailed report accompanying the model is mandatory. The report should include: An introduction to the concept or problem being addressed, a description of the model's design, materials used, and working principles, step-by-step documentation of the construction process, an analysis of the model's performance and any challenges faced, and conclusions or recommendations for future improvements."],
                ["Presentation Guidelines", "Prepare a brief oral presentation (5-10 minutes) to explain your model, its functionality, and its real-world applications. Be ready to answer questions from the judges and audience."]
            ],
            [
                ["Costume", "Participants must wear costumes representing a character from any genre (e.g., anime, movies, video games)."],
                ["Time Limit", "Participants will have 2 minutes to showcase their character on stage."],
                ["Safety", "No sharp objects, real weapons, or dangerous materials are allowed in the cosplay."],
                ["Music Track Submission", "Participants are required to submit their music tracks to the student coordinator prior to the event. The contact number for the student coordinator has been provided in the registration form. Ensure that your tracks are submitted in MP3 format and by the deadline to avoid any last-minute issues."]
            ],
            [
                ["Platform", "The competition will be held on a pre-determined platform."],
                ["Coding Languages", "Participants can code in any coding language supported by the platform."],
                ["Disqualification", "Plagiarism or cheating in any form leads to immediate disqualification."],
                ["Time Allotted", "90 minutes"],
                ["Reporting Time", "2:30pm (participants must be present 10 minutes before the event starts)"]
            ],
            [
                ["Competition Format", "Participants must create a short anime concept or storyboard up to 3 panels with their own original storyline."],
                ["Theme", "Anime"],
                ["Solo Participation", "The competition is an individual event. Teaming up with others is not allowed."],
                ["Medium", "The competition will be conducted digitally. Participants are required to bring their own digital drawing pad and any other necessary equipment."],
                ["Submission Guidelines", "The storyboard must consist of a maximum of 3 panels. All entries must be original works created during the competition time frame. Participants must provide a brief explanation of their concept, storyline, and creative process along with their submission."]
            ],
            [
                ["Time Limit", "1.5 hours"],
    ...
    [
        "Ms. Roosha Shamoon",
        "Ms. Pinki Uniyal",
        "Mr. Sukesh Kumar Bhagat"
    ],
    [
        "Ms. Pratibha Dimri",
        "Ms. Shraddha Kalkhundiya",
        "Mr. Jitendra Kumar"
    ],
    [
        "Ms. Anuradha Brijwal (CSE)",
        "Ms. Ankita Butoiya",
        "Ms. Garima Panwar"
    ]
    ]
    ...
    const date=["September 12th, 2024"," September 12th, 2024","September 13th, 2024","September 12th, 2024","September 12th, 2024","September 13th, 2024","September 13th, 2024","September 12th, 2024","September 12th, 2024","September 12th, 2024","September 11th, 2024","September 13th, 2024","September 12th, 2024","September 12th, 2024","September 12th, 2024","September 13th, 2024"]
    const time=["11:00 AM - 1:00 PM","9:30 AM - 01:30 PM","10:00 AM onwards","2:00 PM - 4:00 PM","10:30 AM - 12:30 PM","10:00 AM onwards","2:30 PM - 3:30 PM","2:00 PM – 3:00 PM","10:00 AM - 11:30 AM","2:30 PM – 3:30 PM","2:30 PM – 4:30 PM","10:00 AM onwards","11:30 AM – 1:30 PM","2:30 PM – 4:00 PM","2:30 PM – 4:00 PM","10:00 AM onwards"]
    const venue=["UIT Ground Floor","Central Computer Lab","UIT Premises","In front of Guest House, UU","Central Computer Lab","UIT Premises","UIT Premises","Near Lamour Bakehouse","Swami Vivekananda Auditorium","Will be allotted soon","Will be allotted soon","Ground Floor (UIT)","Swami Vivekananda Auditorium","Central Computer Lab","Will be allotted soon","Ground floor UIT"]
    const title=["Canvas on Faces","BGMI Badshah","Digital India","Engineer's Got Talent","HTML Combat","Pirates","UU Picasso","Engineer's Stride","Mr. & Ms. UU","Head Scratch","Life of an Engineer","Innovate India","Character Clash","Crack N Code","Anyday Anime","Cook Without Fire"]

        return <Eventspage title={title[index]} descriptions={descriptions[index]} eventguid={eventguid[index]} judCriteria={judCriteria[index]} facultyCod={facultyCod[index]} studentCod={studentCod[index]} date={date[index]} time={time[index]} venue={venue[index]}/>
    }
